...
The attached figures showcase the optimal policy in Baron-Myerson setting with uniform demand and cost for $\alpha = 0$ or $1$. See [here](https://drive.google.com/file/d/10Ul3gY62cWk6zE-DO6ukUTu8eaGj766z/view?usp=sharing) for a quick tutorial on Baron-Myerson model.
